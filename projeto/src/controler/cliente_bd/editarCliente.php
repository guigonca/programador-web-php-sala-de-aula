...
if($idCliente > 0){
    ...
    $tipo = isset($_POST['tpcliente']) ? $_POST['tpcliente'] : "";
    $sexo = isset($_POST["sexo"]) ? $_POST["sexo"] : "";
    $email = isset($_POST["email"]) ? $_POST["email"] : "";
    $senha = isset($_POST["senha"]) ? password_hash($_POST["senha"], PASSWORD_DEFAULT) : "";
    $ativo = isset($_POST["ativo"]) ? $_POST["ativo"] : true;

    $sql_code = "UPDATE cliente SET nome = '$nome', data_nascimento = '$dataNascimento', orgao = '$orgao', rg = '$rg', cpf = '$cpf', estado_civil = '$estadoCivil', tpcliente = '$tipo', ' sexo = '$sexo', email = '$email', senha = '$senha' WHERE idcliente = '$idCliente'";
